...
class StorePreview(Gtk.FlowBoxChild):
    ...
    def build(self):
        ...
        self.github_button = Gtk.Button(icon_name="com.core447.StreamController:web-browser-symbolic",
                                        hexpand=True,
        ...
        self.install_uninstall_button = Gtk.Button(icon_name="com.core447.StreamController:folder-download-symbolic",
                                          hexpand=True,
    ...
    def set_install_state(self, state: int):
        ...
        if state == 0:
            self.install_uninstall_button.set_icon_name("com.core447.StreamController:folder-download-symbolic")
            ...
            self.install_uninstall_button.set_icon_name("com.core447.StreamController:user-trash-symbolic")
