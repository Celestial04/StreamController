...
class ChooserPage(Gtk.Stack):
    ...
    def _build(self):
        ...
        self.video_button = Gtk.ToggleButton(icon_name="com.core447.StreamController:camera-video-symbolic", css_classes=["blue-toggle-button"])
        self.video_button.connect("toggled", self.on_video_toggled)
        self.type_box.append(self.video_button)

        self.image_button = Gtk.ToggleButton(icon_name="com.core447.StreamController:camera-photo-symbolic", css_classes=["blue-toggle-button"])
