...
class PageSelector(Gtk.Box):
    ...
    def build(self):
        ...
        # Settings button
        self.open_manager_button = Gtk.Button(icon_name="com.core447.StreamController:folder-open-symbolic", tooltip_text=gl.lm.get("header-page-selector-page-manager-hint"))
