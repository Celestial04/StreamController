...
class MissingActionButtonRow(Adw.PreferencesRow):
    def __init__(self, action_id:str, page_coords:str, index:int):
        ...
        self.remove_button = Gtk.Button(icon_name="com.core447.StreamController:user-trash-symbolic", vexpand=False, halign=Gtk.Align.END, css_classes=["red-background"], margin_end=0,
